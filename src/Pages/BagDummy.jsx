      ...
      <div className='flex shadow-xl/30 flex bg-white w-320 ml-75 gap-8 mt-8 mb-20'>
             ...
             <div className='flex'>
                  <button className="flex  gap-2 bg-yellow-400 ml-3 border hover:bg-yellow-300 text-black font-semibold py-2 px-6 rounded mt-4 "><LuShoppingBag className="w-35 h-5 " />ADD TO BAG</button>
                      <button onClick={() => dispatch(addToCard(pro1))} className="bg-white-900 border w-47 ml-2 hover:bg-gray-200 text-black font-semibold py-2 px-4 rounded mt-4"> WISHLIST
                     </button>
             </div>
           ...
           <p className='ml-6 mt-2 font-semibold text-2xl '>Save extra with these offers</p>
                   ...
                   <div>
                      <button onClick={() => navigate("/paymentpage")} className=" ml-7 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 w-58 px-4 rounded cursor-pointer mt-7">Buy Now </button>
