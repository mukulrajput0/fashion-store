...
import { Link } from 'react-router-dom'
 ...
 export const t1 =[
  {id:1, name:"C-Store", title:"Black Slim Fit Trouser", Price:799,price:999, Discount:"30-40% Off", image:Img12},
  {id:2, name:"C-Store", title:"Beige Cotton Chinos", Price:499,price:900, Discount:"30-40% Off", image:Img13},
  {id:3, name:"C-Store", title:"Grey Formal Trouser", Price:599,price:999, Discount:"30-40% Off", image:Img14},
  {id:4, name:"C-Store", title:"Navy Blue Slim Trouser", Price:500,price:800, Discount:"30-40% Off", image:Img15},
  {id:5, name:"C-Store", title:"Olive Green Cargo Trouser", Price:600,price:900, Discount:"30-40% Off", image:Img16},
  {id:6, name:"C-Store", title:"Light Grey Joggers", Price:599,price:999, Discount:"30-40% Off", image:Img17},
  {id:7, name:"C-Store", title:"Khaki Straight Fit Trouser", Price:500,price:800, Discount:"30-40% Off", image:Img18},
  {id:8, name:"C-Store", title:"Dark Brown Casual Trouser", Price:499,price:799, Discount:"30-40% Off", image:Img19},
  {id:9, name:"C-Store", title:"Charcoal Black Chinos", Price:599,price:899, Discount:"30-40% Off", image:Img20},
  {id:10, name:"C-Store", title:"Steel Blue Formal Trouser", Price:399,price:699, Discount:"30-40% Off", image:Img21},
  {id:11, name:"C-Store", title:"Tan Regular Fit Trouser", Price:499,price:899, Discount:"30-40% Off", image:Img22},
  {id:12, name:"C-Store", title:"White Slim Fit Chinos", Price:699,price:999, Discount:"30-40% Off", image:Img23},
  {id:13, name:"C-Store", title:"Dark Olive Cargo Trouser", Price:400,price:700, Discount:"30-40% Off", image:Img24},
  {id:14, name:"C-Store", title:"Denim Blue Joggers", Price:499,price:899, Discount:"30-40% Off", image:Img25},
  {id:15, name:"C-Store", title:"Classic Black Formal Trouser", Price:499,price:799, Discount:"30-40% Off", image:Img26},
]
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 ml:grid-cols-4 gap-6 mt-10 items-center justify-center   ml-10 mr-10'>
        {t1.map((item) => (
          <div key={item.id} className=" rounded p-1 shadow hover:shadow-ml  transition">
               <Link to={`/hometouserdummy/${item.id}`}><img src={item.image} alt={item.name} className='hover:brightness-75 cursor-pointer w-full h-120 object-cover' /></Link>
