...
import { Link } from 'react-router-dom'
 ...
 export const f=[
    { id: 20,name:"C-Store", title:"Women's Brown Oversized Cotton Jecket", Price: 1499,price:1999, Discount: "30-40% Off", image: Img23 },
  { id: 21,name:"C-Store", title:"Women's Olive Green Oversized Graphic T-shirt", Price: 999,price:1199,  Discount: "30-40% Off", image: Img24 },
  { id: 22,name:"C-Store", title:"Women's White Minimalist Graphic Whoolen", Price: 799,price:1399,  Discount: "30-40% Off", image: Img25 },
  { id: 23,name:"C-Store", title:"Women's Black Streetwear Oversized Jecket", Price: 1499,price:2000,  Discount: "30-40% Off", image: Img26 },
  { id: 24,name:"C-Store", title:"Women's Yellow Loose Fit Summer Hoodie", Price: 599,price:999,  Discount: "30-40% Off", image: Img27 },
   { id: 25,name:"C-Store", title:"Women's Brown Oversized Cotton full-T-shirt", Price: 699,price:999, Discount: "30-40% Off", image: Img28 },
  { id: 26,name:"C-Store", title:"Women's Olive Green Oversized Graphic T-shirt", Price: 399,price:599,  Discount: "30-40% Off", image: Img29 },
  { id: 27,name:"C-Store", title:"Women's White Minimalist Graphic T-shirt", Price: 299,price:599,  Discount: "30-40% Off", image: Img30 },
  { id: 28,name:"C-Store", title:"Women's Black Streetwear Oversized full-T-shirt", Price: 699,price:999,  Discount: "30-40% Off", image: Img31 },
  { id: 29,name:"C-Store", title:"Women's Yellow Loose Fit Summer ful--T-shirt", Price: 899,price:1199,  Discount: "30-40% Off", image: Img32 },
  { id: 30,name:"C-Store", title:"Women's Brown Loose Fit Summer full-T-shirt", Price: 599,price:899,  Discount: "30-40% Off", image: Img33 },
  { id: 31,name:"C-Store", title:"Women's Cream Loose Fit Summer full-T-shirt", Price: 799,price:999,  Discount: "30-40% Off", image: Img34 },
  { id: 32,name:"C-Store", title:"Women's Blue Loose Fit Summer T-shirt", Price: 899,price:1199,  Discount: "30-40% Off", image: Img35 },
]
    ...
    <div>
        ...
        {f.map((item) => (
          <div key={item.id} className=" rounded p-1 shadow hover:shadow-ml  transition">
            <Link to={`/women-collectiona/${item.id}`}><img src={item.image} alt={item.name} className='hover:brightness-75 cursor-pointer w-full h-120 object-cover' /></Link>
